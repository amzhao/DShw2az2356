...
each month. All of the observations were kept. However, S\&P is missing
for many timepoints as this dataset was the smallest, with only 787
months of data from 1950 to 2015, compared to the politician data, which
had 822 months of data, from 1947 to 2015. Thus, the resulting dataset
contains 822 months of data, with comprehensive data for the
politicians, and missing unemployment and S\&P data for some months.
